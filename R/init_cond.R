generate_init_condi <- function(r0,
  ...
  stopifnot(r0>=0 & r0<=1 & Die>=0 & Dil>=0 & Dp>=0 & De>=0 & all(Dp>=0) & alpha>=0 & alpha<=1 & Dh>=0 & N>=0 & all(flowN>=0))
  ...
  #Ae0<-10
  #Al0<-23
  S0 <- N - E0 - P0 - Ie0 - Il0 - Ae0 - Al0 - H0 - R0
  init_states <- round(c(S = S0, E = E0, P = P0, Ie = Ie0, Il=Il0, Ae=Ae0, Al = Al0, H = H0, R = R0), 0)
  print(Ie0)
  ## helper function
  ...
  return(list(Die=Die,
         ...
         par_lower = c(b12 = 0, b3 = 0, b4 = 0, b5 = 0, r12 = 0, delta3 = -10, delta4 = -10, delta5 = -10, m=0),
         par_upper = c(b12 = 2, b3 = 2, b4 = 2, b5 = 2, r12 = 1, delta3 = 10, delta4 = 10, delta5 = 10, m=1)))
