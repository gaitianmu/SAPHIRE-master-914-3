...
Findzero <- function(pars_estimate, init_settings) {
  ...
  ##
  est_mat <- apply(pars_estimate, 1, function(x) SEIRsimu(pars = x, init_settings = init_settings, num_periods = 5)[, c("Ie","Il" ,"P", "E", "Ae","Al")])
  est_mat_I <- est_mat[1:200, ]
  est_mat_EPIA <- est_mat[1:200, ] + est_mat[201:400, ] + est_mat[401:600, ] + est_mat[601:800, ]+est_mat[801:1000, ]+est_mat[1001:1200, ]
  ## I = 0
